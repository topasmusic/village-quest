...
- Captured the exact randomized mature Wheat, Potato, and Carrot stack at Minecraft's resource-spawn call. This avoids losing normal harvest progress to item-entity timing while still crediting the full real yield exactly once.
- Extended that exact resource-spawn capture to tracked Coal, Raw Iron, Redstone, Raw Gold, Diamond, Lapis, and Amethyst drops, so Fortune and other randomized stack sizes match the progress shown by Village Quest.
