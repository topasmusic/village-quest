...
public final class VillageUiTheme {
    ...
    public static void blitScaled(DrawContext graphics, Identifier texture, int x, int y,
        ...
        matrices.push();
        matrices.translate(x, y, 0);
        matrices.scale(width / (float) textureWidth, height / (float) textureHeight, 1);
        graphics.drawTexture(texture, 0, 0, 0.0f, 0.0f,
    ...
    private static void blitRegionScaled(DrawContext graphics, Identifier texture,
        ...
        matrices.push();
        matrices.translate(x, y, 0);
        matrices.scale(width / (float) sourceWidth, height / (float) sourceHeight, 1);
        graphics.drawTexture(texture, 0, 0,
