...
public final class PaintingStackFactory {
    ...
    public static ItemStack create(ServerWorld world, String variantPath) {
        ...
        RegistryEntry<PaintingVariant> variantEntry = world.getRegistryManager().get(RegistryKeys.PAINTING_VARIANT).getEntry(variantKey).orElseThrow();
    ...
    public static ItemStack create(RegistryEntry<PaintingVariant> variantEntry) {
        ...
        if (variantKey != null) {
            ...
            entityData.putString("variant", variantKey.getValue().toString());
