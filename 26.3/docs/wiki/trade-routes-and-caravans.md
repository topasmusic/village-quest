...
This page describes the `2.0.0 - Roads Between Villages` trade-route and Trade-Guild system in the Minecraft `26.3` line. The same gameplay is available in the Minecraft `26.2` maintenance line.
