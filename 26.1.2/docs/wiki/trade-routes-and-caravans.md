...
The `2.1.0` economy adds route-targeted Road Patrol, Survey Report, and Emergency Recall services. Forge Prosperity discounts permanent route-upgrade prices, while Road Watch Prosperity reduces recurring incident chance. Five collectible liveries synchronize each route's caravan outfits, full-map line, minimap line, and accent. See [Prosperity and the Village Economy](./prosperity-and-economy.md).
